                        ...
                        <div class="row product-info">
                            <div class="col-sm-6">
                                <div class="image"><img class="img-responsive" itemprop="image" id="zoom_01"
                                        src="{{asset('front/image/product/macbook_air_1-350x350.jpg')}}" title="لپ تاپ ایلین ور"
                                        alt="لپ تاپ ایلین ور"
                                ...
                                <div class="image-additional" id="gallery_01"> <a class="thumbnail" href="#"
                                        ...
                                        <img src="{{asset('front/image/product/macbook_air_1-66x66.jpg')}}" title="لپ تاپ ایلین ور"
                                        ...
                                        title="لپ تاپ ایلین ور"><img src="{{asset('front/image/product/macbook_air_4-66x66.jpg')}}"
                                        ...
                                        title="لپ تاپ ایلین ور"><img src="{{asset('front/image/product/macbook_air_2-66x66.jpg')}}"
                                            title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" /></a> <a class="thumbnail"
                                        href="#" data-zoom-image="image/product/macbook_air_3-500x500.jpg"
                                        data-image="image/product/macbook_air_3-350x350.jpg"
                                        title="لپ تاپ ایلین ور"><img src="{{asset('front/image/product/macbook_air_3-66x66.jpg')}}"
